...
function rollQuestion() {
    ...
    if(questionIndex==8||questionIndex==13||questionIndex==19||questionIndex==20||questionIndex==21||questionIndex==25||questionIndex==27||questionIndex==28||questionIndex==29||questionIndex==30) {
        questionSpan.classList.add('long-question');
        nextQuestionBtn.classList.add('mt');
    }
}
...
function closeQuestion() {
    ...
    nextQuestionBtn.classList.remove('mt');
    questionSpan.classList.remove('long-question');
